...
class HardwareTriggerConfig:
    ...
    enable_voice: bool = False  # Default to False for text-first interaction
...
class VoiceTriggerListener:
    ...
    def start(self):
        ...
        try:
            ...
            logger.warning("Voice trigger disabled due to initialization error. Other triggers (hotkey/gesture) will still work.")
            return False
